...
import type { GateOutcome } from '../../src/modules/pipeline/track-a-description/threshold/evidence-gate.js';
import type { LlmPickResult } from '../../src/modules/pipeline/track-a-description/picker/llm-pick.js';

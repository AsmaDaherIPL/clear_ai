  ...
  annotated_candidates: [
    {
      ...
      path_en: 'Other > T-shirts > T-shirts of cotton',
      path_ar: 'غيرها > قمصان > قمصان قطن',
      fit: 'fits',
      confidence: 0.88,
    ...
    },
    {
      ...
      path_en: 'Other > T-shirts > Other textile materials',
      path_ar: 'غيرها > قمصان > مواد أخرى',
      fit: 'partial',
      confidence: 0.45,
    ...
    },
    {
      ...
      path_en: 'Underwear > Briefs and panties',
      path_ar: 'الملابس الداخلية > سراويل',
      fit: 'does_not_fit',
      confidence: 0.15,

 ...
 * DATABASE_URL like the rest of the batches suite).
 */
import { describe, it, expect, vi, beforeEach } from 'vitest';

const listBatchesMock = vi.fn();
vi.mock(
  '../../src/modules/batches/batch.repository.js',
  () => ({
...
import { handleListBatches } from '../../src/modules/batches/batch.controller.js';
import { BatchValidationError } from '../../src/modules/batches/batch.errors.js';

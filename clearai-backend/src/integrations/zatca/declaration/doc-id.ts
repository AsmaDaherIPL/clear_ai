 ...
 *
 * where:
 *   • prefix: operator-specific (Naqel = "NQD"; future tenants will differ).
 ...
 *
 * The prefix lives in operator_constants under key `doc_ref_prefix`. Default
 * 'NQD' if missing.
 */
...
export interface DocIdInput {
  /** Tenant prefix from operator_constants.doc_ref_prefix; falls back to 'NQD'. */
  prefix?: string;
  /**

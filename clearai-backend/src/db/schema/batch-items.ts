 ...
 *
 * Renamed from declaration_run_items in migration 0084 (PR1). The parent
...
export const batchItems = pgTable(
  'batch_items',
  {
     ...
     * batch_items_goods_description_ar_status_consistency_chk.
     */
  ...
  (t) => ({
    ...
    /**
     * Composite (batch_id, row_index) index. Covers
     * WHERE batch_id = $1 lookups via leftmost-prefix AND
